...
## Structure
Hero → the claim → **Proof I: North Port, FL (5 yrs of dated breadcrumbs before the bid feed saw it)** → **Proof II: East Ridge, TN (grant-funded ALPR decided in council; the only bid a feed saw was the electrical-service RFP, ~62 days after the vote)** → six-stage buying-signal lifecycle + "open isn't open" signals table + grant-funded-ALPR chart (70+ agencies, 24 states bought via federal grants — the buy is funded before it's bid) → Where the signal lives (~65% municipal record) → What the pattern implies → Verdict.
...
- **No "average X months early" headline** — the data supports the signal *types* and named real trails (North Port, East Ridge), not a market-wide lead-time average.
